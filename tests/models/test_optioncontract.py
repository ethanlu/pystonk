...
class OptionContractTest(TestCase):
    def testOptionContractInstantiation(self):
        ...
        self.assertEqual(o.contract_type, ContractType.CALL, 'OptionContract did not normalize contract type')
        ...
        self.assertEqual(o.bid_size, 3, 'OptionContract did not normalize bid size')
        self.assertEqual(o.ask_size, 4, 'OptionContract did not normalize ask size')
        ...
        self.assertEqual(o.open_interest, 5, 'OptionContract did not normalize open interest')
