...
class WeeklyOptionsReportTest(TestCase):
    ...
    def testReport(self):
        ...
        to = o.getStrikePricesForTargetPremium(premium)
        self.assertEqual(to.call.strikePrice, 110.00, "WeeklyOptionsReport did not return expected target call strike")
        self.assertEqual(to.call_diff, 9.75, "WeeklyOptionsReport did not return expected target call strike diff")
        self.assertEqual(to.call_diff_percent, 9.73, "WeeklyOptionsReport did not return expected target call strike percent change")
        self.assertEqual(to.put.strikePrice, 95.00, "WeeklyOptionsReport did not return expected target put strike")
        self.assertEqual(to.put_diff, -5.25, "WeeklyOptionsReport did not return expected target put strike diff")
        self.assertEqual(to.put_diff_percent, -5.24, "WeeklyOptionsReport did not return expected target put strike percent change")